...
export class QueryBuilder<T extends QueryBuilderEndpoint> implements QueryBuilderBase<T> {
    ...
    public readonly and:(cb: (builder: QueryBuilderBase<T>) => void) => QueryBuilder<T> = this.#proxify(this.#and);
    public readonly or: (cb: (builder: QueryBuilderBase<T>) => void) => QueryBuilder<T> = this.#proxify(this.#or);
    public readonly f: (name: QueryBuilderFilter<T>) => QueryBuilderOperator<T> = this.#proxify(this.#filter);
    public readonly filter: (name: QueryBuilderFilter<T>) => QueryBuilderOperator<T> = this.#proxify(this.#filter);
    public readonly v: (value: any) => QueryBuilder<T> = this.#proxify(this.#value);
    public readonly value: (value: any) => QueryBuilder<T> = this.#proxify(this.#value);
